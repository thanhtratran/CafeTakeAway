					...
					<div class="tiva-slideshow-wrapper">
						<div id="tiva-slideshow" class="nivoSlider">
							<a href="#"> <img class="img-responsive"
								src="<c:url value="/assets/user/img/home/slider-4.jpg" />" title="#caption1"
								alt="Slideshow image">
							</a> <a href="#"> <img class="img-responsive"
								src="<c:url value="/assets/user/img/home/slider-5.jpg" />" title="#caption2"
								alt="Slideshow image">
							</a> <a href="#"> <img class="img-responsive"
								src="<c:url value="/assets/user/img/home/slider-6.jpg" />" title="#caption3"
								alt="Slideshow image">
							</a>
						</div>
					</div>
								...
								<div class="section spacing-10 group-image-special">
									<div class="row">
										...
										<div class="col-lg-6 col-md-6 banner1">
											<div class="effect">
												<a href="#"> <img class="img-fluid width-100"
													src="<c:url value="/assets/user/img/home/Blog3.jpg" />" alt="banner-2"
													title="banner-2">
												</a>
											</div>
										</div>
										<div class="col-lg-6 col-md-6 banner1">
											<div class="effect">
												<a href="#"> <img class="img-fluid width-100"
													src="<c:url value="/assets/user/img/home/Blog9.jpg" />" alt="banner-2"
													title="banner-2">
												</a>
											</div>
										</div>
																...
																<div class="product-groups">
																	...
																	<div class="rating">
																		...
																		<div class="product-price-and-shipping">
																			<span class="price">
																				<p>
																					<del><fmt:formatNumber type = "number" maxFractionDigits = "3" value = "${ item.donGia}" /></del>
																					đ
																				</p>
																			</span>
																	...
																	<div class="product-group-price">
																		<div class="product-price-and-shipping">
																			<span class="price"><fmt:formatNumber type = "number" maxFractionDigits = "3" value = "${item.donGiaSauKM}" /></span> đ
																		</div>
																	</div>
										...
										<c:if test="${ spkm.size() > 0 }">
											<div class="tab-content">
												...
												<div class="content-showmore text-center has-showmore">
													...
													<a class="btn btn-default novShowMore" href="<c:url value="/products" />"><span>Tất
															cả sản phẩm</span></a> <input type="hidden" value="0"
